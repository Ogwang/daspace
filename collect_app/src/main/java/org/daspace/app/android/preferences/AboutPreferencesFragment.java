...
import org.daspace.app.android.activities.OpenSourceLicensesActivity;
import org.daspace.app.android.utilities.CustomTabHelper;
...
public class AboutPreferencesFragment extends BasePreferenceFragment implements Preference.OnPreferenceClickListener {
    ...
    private static final String ODK_WEBSITE = "http://daspace.org";
    private static final String ODK_FORUM = "http://forum.daspace.org";
